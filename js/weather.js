...
const Weather = (() => {
  ...
  const ICONS = {
    sun: '<svg viewBox="-2 -2.5 28 28" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="4.5" stroke="currentColor" stroke-width="1.6"/><path d="M12 2.5v2.5M12 19v2.5M4.5 12H2M22 12h-2.5M5.6 5.6l1.8 1.8M16.6 16.6l1.8 1.8M18.4 5.6l-1.8 1.8M7.4 16.6l-1.8 1.8" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>',
    'sun-cloud': '<svg viewBox="-2 -2.5 28 28" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="9" cy="9" r="3.5" stroke="currentColor" stroke-width="1.6"/><path d="M9 3.5v1.5M9 12.5V14M3.5 9H5M13 9h1.5M5.1 5.1l1 1M11.9 5.1l-1 1" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/><path d="M8 19.5h9.5a3.5 3.5 0 0 0 0-7 5 5 0 0 0-9.4-1.6" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>',
    cloud: '<svg viewBox="-2 -2.5 28 28" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6.5 18.5h11a4 4 0 0 0 0-8 6 6 0 0 0-11.4-1.8A4.5 4.5 0 0 0 6.5 18.5z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/></svg>',
    fog: '<svg viewBox="-2 -2.5 28 28" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6.5 13.5h11a4 4 0 0 0 0-8 6 6 0 0 0-11.4-1.8A4.5 4.5 0 0 0 6.5 13.5z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/><path d="M4 17.5h16M4 21h16" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>',
    drizzle: '<svg viewBox="-2 -2.5 28 28" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6.5 12.5h11a4 4 0 0 0 0-8 6 6 0 0 0-11.4-1.8A4.5 4.5 0 0 0 6.5 12.5z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/><path d="M9 17v2.2M13 17v2.2M17 17v2.2" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>',
    rain: '<svg viewBox="-2 -2.5 28 28" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6.5 12.5h11a4 4 0 0 0 0-8 6 6 0 0 0-11.4-1.8A4.5 4.5 0 0 0 6.5 12.5z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/><path d="M8.5 16.5l-1.5 3M13 16.5l-1.5 3M17.5 16.5l-1.5 3" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>',
    showers: '<svg viewBox="-2 -2.5 28 28" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6.5 11.5h11a4 4 0 0 0 0-8 6 6 0 0 0-11.4-1.8A4.5 4.5 0 0 0 6.5 11.5z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/><path d="M7.5 15.5l-1.5 3M12 15.5l-1.5 3M16.5 15.5l-1.5 3M9.7 19l-1 2.2M14.2 19l-1 2.2" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>',
    snow: '<svg viewBox="-2 -2.5 28 28" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6.5 12.5h11a4 4 0 0 0 0-8 6 6 0 0 0-11.4-1.8A4.5 4.5 0 0 0 6.5 12.5z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/><path d="M9 16.5v5M6.7 18l4.6 2M13.7 18l-4.6 2M15 16.5v5M12.7 18l4.6 2M19.7 18l-4.6 2" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/></svg>',
    storm: '<svg viewBox="-2 -2.5 28 28" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6.5 11.5h11a4 4 0 0 0 0-8 6 6 0 0 0-11.4-1.8A4.5 4.5 0 0 0 6.5 11.5z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/><path d="M13 14.5l-3 4.5h3l-2 4.5" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>'
  };
